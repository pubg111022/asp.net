...
namespace Client.Areas.Admin.Controllers
{
    ...
    public class LogoutController : Controller
    {
        ...
        public LogoutController(RecruitmentManagementContext context , IToastNotification toastNotification)
        {
        ...
        // GET: Admin/Logout/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Admin/Logout/Create
